...
const services = [
  {
    ...
    subtitle: "SECURITY",
    description: "we assess, design, and manage integrated security ecosystems that merge physical, cyber, and operational resilience — keeping organizations ahead of evolving threats.",
    image: "/assets/services/services1.png",
  },
  {
    id: 2,
    title: "REAL-TIME VISIBILITY. TOTAL CONTROL.",
    subtitle: "SURVEILLANCE",
    description: "AI-enabled camera networks and secure command centers for continuous situational awareness.",
  ...
  },
  {
    ...
    description: "Actionable intelligence pipelines designed to detect, predict, and neutralize threats.",
  ...
  },
  {
    ...
    subtitle: "ROBOTICS",
    description: "Advanced robotic and drone systems for perimeter defense and reconnaissance.",
    image: "/assets/services/services4.png",
  },
  {
    id: 5,
    title: "EXECUTIVE & PERSONAL PROTECTION",
    subtitle: "PROTECTION",
    description: "Discreet, intelligence-driven personal security detail operations.",
    image: "/assets/services/services5.png",
  },
];
